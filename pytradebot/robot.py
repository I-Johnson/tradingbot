# Interact with the TD Ameritrade API
import pandas as pd

from td.client import TDClient
from td.utils import milliseconds_since_ephoc
...
from pytradebot.portfolio import Portfolio
...
class PyRobot():
    ...
    def grab_current_quotes(self) -> dict:
        ...
        #Grab the quotes. 
        quotes = self.session.get_quotes(instrunments = list(symbols))
